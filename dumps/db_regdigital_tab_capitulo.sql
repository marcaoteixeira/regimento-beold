...
CREATE TABLE `tab_capitulo` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tab_capitulo_tab_titulo` (`id_titulo`),
  CONSTRAINT `FK_tab_capitulo_tab_titulo` FOREIGN KEY (`id_titulo`) REFERENCES `tab_titulo` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2023-04-13 12:54:16
