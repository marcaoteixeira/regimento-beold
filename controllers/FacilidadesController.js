const Quorum = require("../models/quorum/quorum");
...
class FacilidadesController {
   ...
   //Uso da Palavra
   async usopalavra(req, res) {
      var list_palavra = await Usopalavra.findAll();
      res.render('usopalavra/usopalavra', { usopalavra: list_palavra });
   }
